...
void ActiveF7Control()
{
	...
	//SetNationRelation2MainCharacter(SPAIN, RELATION_ENEMY);
			...
			dumpattributes(sld);*/
			/*sld = &Islands[FindIsland("SantaCatalina")];
			dumpattributes(sld);*/

			aref ssld;
			makearef(ssld, NullCharacter.capitainBase);
			dumpattributes(ssld);
	...
	/*sld = GetCharacter(NPC_GenerateCharacter("SoleiRoyalCaptain2", "crabBig", "crab", "crabBig", 35, ENGLAND, -1, false));
	...
	//pchar.questTemp.StartRain = true;
	...
	//bDisableLandEncounters = true;
			...
			//GiveItem2Character(pchar, "SkullAztec");
