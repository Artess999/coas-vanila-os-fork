...
void ShowAllLocators()
{
  VisibleLocatorsGroup("candles", 1.0, 15.0, 255, 255, 255, 55);
        VisibleLocatorsGroup("candles_medium", 1.0, 15.0, 255, 255, 255, 55);
        VisibleLocatorsGroup("cave", 1.0, 15.0, 255, 0, 255, 255);
        VisibleLocatorsGroup("chandeliers", 1.0, 15.0, 255, 128, 0, 128);
        VisibleLocatorsGroup("torchlightes", 1.0, 15.0, 255, 255, 155, 0);
        VisibleLocatorsGroup("torchlightes_o", 0.1, 15.0, 55, 0, 0, 255);
        VisibleLocatorsGroup("outside", 1.0, 15.0, 255, 155, 155, 255);
        ...
        VisibleLocatorsGroup("incas_light", 1.0, 15.0, 255, 155, 255, 255);
        VisibleLocatorsGroup("incas_sky", 1.0, 15.0, 255, 0, 255, 255);
        VisibleLocatorsGroup("inside_day", 1.0, 15.0, 255, 0, 255, 255);
        VisibleLocatorsGroup("outside", 1.0, 15.0, 255, 155, 155, 255);
        VisibleLocatorsGroup("torchlightes", 1.0, 15.0, 255, 255, 155, 0);
        VisibleLocatorsGroup("torchlightes_o", 1.0, 15.0, 55, 0, 0, 255);
        VisibleLocatorsGroup("lamp", 1.0, 15.0, 55, 220, 120, 20);
...
{
HideLocatorsGroup("candles");
        HideLocatorsGroup("candles_medium");
        HideLocatorsGroup("cave");
        HideLocatorsGroup("chandeliers");
        HideLocatorsGroup("torchlightes");
        HideLocatorsGroup("torchlightes_o");
        HideLocatorsGroup("outside");
        HideLocatorsGroup("fonar");
        HideLocatorsGroup("heaters");
        HideLocatorsGroup("incas_light");
        HideLocatorsGroup("incas_sky");
        HideLocatorsGroup("inside_day");
        HideLocatorsGroup("outside");
        HideLocatorsGroup("torchlightes");
        HideLocatorsGroup("torchlightes_o");
        HideLocatorsGroup("lamp");
