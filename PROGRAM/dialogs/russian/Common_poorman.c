	...
	switch(Dialog.CurrentNode)
	{
		case "First time":
			...
			else
			{
				...
				{
					link.l1 = "Послушай, мне кажется, что я нашел в резиденции Стэвезанта нечто весьма интересное!";
		...
		break;
		case "GoodTalk_1_1":
			dialog.text = "Я даже не знаю, что и сказать... Сам, наверное, понимаешь, что мы люди бездомные, отношение к нам пренебрежительное.";
		...
		break;
		case "GoodTalk_2_3":
			dialog.text = "Хо-о-о, вот это да!.. Ну, ты сам, наверное, понимаешь, что вреда от нас для окружающих - вонь да блохи. Если из-за этого кто-то готов нас убивать, то я вообще ничего не понимаю в этой жизни!";
		...
		case "GoodTalk_3":
			...
			link.l1 = "Я тут столкнулся с довольно неожиданным обстоятельством... В общем, дело в том, что на Карибах есть люди, очень недовольные вашим братом.";
		...
		case "FoundLetter":
			...
			link.l1 = "Вот письмо, которое я раздобыл в резиденции Стэвезанта. Это переписка между ним и Голландской Вест-Индской компанией. Из него явно следует, что затеяла уничтожение нищих именно данная торговая компания.";
