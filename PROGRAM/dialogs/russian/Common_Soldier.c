...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
			...
			else
			{
				...
				else
				{
					...
					switch (rand(10))
					{
						...
						case 9://///////////////////////////////////////////
							dialog.text = "Ты выглядишь крепким парнем! Не хочешь поступить на службу? У нас просторная казарма, двухразовое питание, плюс выпивка бесплатно.";
		...
		case "PegYou":
			dialog.text = RandPhraseSimple("Сдается мне, что это обман... Давай-ка пройдем в комендатуру, голубчик, там разберемся...", "Хм, что-то подсказывает мне, что ты не тот, за кого себя выдаешь... Немедленно сдайте оружие, " + GetAddress_Form(npchar) + ", и следуйте за мной для дальнейшего разбирательства!");
