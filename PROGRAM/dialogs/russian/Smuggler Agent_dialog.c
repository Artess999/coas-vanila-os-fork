	...
	switch(Dialog.CurrentNode)
	{
		...
		case "First time":			
			...
			else
			{
				...
				{
	       			Dialog.Text = RandPhraseSimple("Говори быстрей, приятель, что тебе надо? А то, знаешь ли, погоня за тобой!", "Не медли, быстрее излагай суть дела! За тобой солдатня бегает, не до долгих бесед, знаешь ли...");
				}
