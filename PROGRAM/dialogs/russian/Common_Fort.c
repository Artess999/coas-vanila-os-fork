...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
			...
			else
			{
				...
				else
				{
					...
					switch (rand(10))
					{
						...
						case 9://///////////////////////////////////////////
							dialog.text = "Ты выглядишь крепким парнем! Не хочешь поступить на службу в гарнизон форта? У нас просторная казарма, двухразовое питание, плюс выпивка бесплатна.";
					...
					link.l3 = "Н-да... ясно. Я вот что хотел спросить...";
		...
		case "PegYou":
			dialog.text = RandPhraseSimple("Сдается мне, что это обман... Давай-ка пройдем к коменданту, голубчик, там разберемся...", "Хм, что-то подсказывает мне, что ты не тот, за кого себя выдаешь... Немедленно сдай оружие, " + GetAddress_Form(npchar) + ", и следуй за мной для дальнейшего разбирательства!");
