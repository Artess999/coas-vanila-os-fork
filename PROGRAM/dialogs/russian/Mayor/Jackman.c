...
// ============================================================================
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "First time":
			...
			{
				link.l1 = "Представляешь, я таки отловил эту шебеку 'Синяя Птица'!";
			...
			{
				link.l1 = "Слушай, Джекмен, ты ничего не знаешь о корсаре, которого стрелой кличут? Или, может быть, он на корабле 'Стрела' ходит...";
				link.l1.go = "Mushket";
			}
		break;
		...
		case "PL_Q1_1":
			dialog.text = "У меня работы нет. Но если ты сейчас ничем не занят, то отправляйся в Пуэрто-Принсипе. Поищи там капитана Гудли, недавно он просил помочь.";
			link.l1 = "А чем помочь?";
			link.l1.go = "PL_Q1_2";
		break;
		case "PL_Q1_2":
			dialog.text = "Не знаю, сам у него спроси.";
			link.l1 = "Понятно...";
			link.l1.go = "exit";
		...
		break;
		case "PL_Q6_5":
			dialog.text = "Отправляйся к заливу Корсумель, что северней Белиза. Там у бухты на фрегате 'Антверпен' стоит Джон Лидс, у него там проблемы с командой. Мне кажется, тебе будет очень интересно его навестить...";
		...
		case "BlueBird_2":
			...
			link.l1 = "Торговцы действительно интересуются этий шебекой. Но, знаешь, мне и самому интересно до жути, что за пернатый такой, от которого уйти нельзя. Это что же идельный каперский парусник по сути своей!";
		...
		//поиски супер-мушкета
		case "Mushket":
			dialog.text = "Хм, есть такой. Ходит на бригантине 'Стрела'. Неплохой парусник, скажу я тебе.";
			link.l1 = "Понятно. А как найти его, не подскажешь?";
			link.l1.go = "Mushket_1";
			DeleteAttribute(pchar, "questTemp.mushket2x2");
		break;
		case "Mushket_1":
			dialog.text = "Нет, не подскажу. Он сам по себе, в Береговое братство не входит. Ни сюда, ни в другие порты он не заходит никогда. Тактика у него заключается в постоянном поиске, берет добычу на абордаж и уходит в какую-нибудь бухту. Его вообще мало кто знает из пиратов.";
			link.l1 = "Н-да... Он мне нужен. Как поступить посоветуешь?";
			link.l1.go = "Mushket_2";
		break;
		case "Mushket_2":
			dialog.text = "Искать, когда будешь ходить в море. Смотри внимательно за проходящими кораблями - эту бригантину ты пропустить не должен...";
