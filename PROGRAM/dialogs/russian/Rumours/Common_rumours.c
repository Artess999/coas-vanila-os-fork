...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		case "LoanForAll": //пересылка в финансы для всех
			...
			link.l9 = RandPhraseSimple("М-м-м, я, видимо, ошибся. Никаких финансовых дел я с вами не веду.", "Простите, никаких финансовых вопросов у меня к вам нет.");
			link.l9.go = "exit";
		break;
        ...
        case "TakeChest_2":
            if (GetCharacterItem(pchar, "Chest") >= sti(pchar.GenQuest.LoanChest.Chest))
            {
				...
				{
					Dialog.Text = "Все это хорошо, и я принимаю у вас золото. Однако, вы не уложились в отведенные вам сроки доставки. Поэтому я вынужден сократить ваш размер вашего гонорара на " + pchar.GenQuest.LoanChest.Money.Discount + "%. Прошу прощения, но это обсуждению не подлежит. Извольте получить...";
					link.l1 = "Спасибо!";
    				link.l1.go = "exit";
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		break;
		case "RBlueBird_9":
			dialog.text = "У одного торговца остался флейт. Но он счастливчик, ни разу не попадал на эту шебеку. Он - наша единственная надежда закрепится здесь, уже все наши ему должны. Если бы он не поддерживал нас в трудную минуту - всем давно пришел бы конец. Он еще никому не отказывал в просьбах дать денег в долг!";
		...
		case "RBlueBird_retMoney_4":
			...
			link.l1 = "Мон шер, не надо так кричать, это пагубно отражается на голосовых связках. А вдруг не сможете потом разговаривать? В общем, я готов говорить с вами только на умеренных тонах...";
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		case "MechanicIsPrison_man_1":
			dialog.text = "Где он сейчас я не знаю. Когда я пришел на 'Сан Габриэль', его как раз выводили милиционеры. Судя по всему, он арестован, и сделать это мог только адмирал.";
