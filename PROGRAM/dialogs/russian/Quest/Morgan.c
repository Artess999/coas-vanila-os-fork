...
// ============================================================================
	switch(Dialog.CurrentNode)
	{
		...
		case "PL_Q2_away_4":
			...
			link.l1 = "Генри, дай мне шанс все исправить! Да я порву его, как старую газету! Без всяких черных меток на ремни порежу!";
		...
		case "PL_Q8_Panama2_2":
			dialog.text = "Он знал, сколько золота в закрытом сундуке. Там 50 миллионов пиастров, приятель! Да ты и без меня уже это знаешь, давай, выкладывай добычу!";
