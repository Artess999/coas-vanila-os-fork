	...
	switch(Dialog.CurrentNode)
	{
        ...
        case "Step_8":
        	dialog.text = "Сейчас происходит следующее - мы с тобой разговариваем.\n"+
                          "А уже произошло великое событие, ожидаемое мной на протяжении шести столетий - я восстал ото сна.";
        ...
        case "Step_15":
        	dialog.text = "Да. Я - Лейф Счастливый, сын Эрика Рыжего, потомок древних свионов, викинг и йорсалирсфари.";
        ...
        case "Step_16":
        	dialog.text = "Викинг - это не нация, корсар. Викинг - это образ жизни, профессия моряка и воина.\n"+
                          "И ты, свободный воин, называешь нас варварами? Шестьсот лет назад мы были лучшими воинами и моряками на земле. Я был в Йорсалире и участвовал в походе на Рим, а мой брат владел Гардарикой!";
        ...
        case "Step_17":
        	dialog.text = "Америкой ты называешь эти большие земли? Ха-ха-ха. Слушай меня, свободный корсар.\n"+
                          ...
                          "В 1000 году я, Лейф Эриксон, отправился на поиски этой земли. Я нашел остров Хеллюланд (Баффинова земля), затем Маркланд (Лабрадор) и Винланд (Ньюфаундленд). На Винланде я основал поселение.\n"+
        ...
        case "Step_18":
        	dialog.text = "Эта земля была открыта мной в 1002 году.\n"+
        ...
        case "Step_27":
        	dialog.text = "За это не волнуйся, я тебе его верну в целости. Твое тело мне не нужно, оно мне не нравится.\n"+
                          "Все, ты можешь идти.";
    		link.l1 = "Хорошо, все это я принесу тебе. А ты пока будь очень осторожен.";
    		link.l1.go = "Step_28";
		break;
