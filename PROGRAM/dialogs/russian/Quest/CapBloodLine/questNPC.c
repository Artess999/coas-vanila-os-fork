...
void ProcessDialogEvent()
{
    ...
    case "JSTStep_0":
    	...
    	link.l1 = "Да вот, хотел прикупить кое-что, а ты на продавца не похож.";
    ...
    case "JSTStep_2":
    	...
    	link.l1 = "Так-так, Жак Соловей, не так ли?";
    ...
    case "JSTStep_3":
    	...
    	link.l1 = "А где же ваш корабль... капитан?";
        link.l1.go = "JSTStep_4";
       	link.l2 = "Присматриваешь... его тут?";
    ...
    case "JSTStep_4":
        ...
        dialog.text = "Э-э-э... он на стоянке... где-то...";
    	link.l1 = "Я могу как-то тебе помочь?";
    ...
    case "JSTStep_6":
    	...
    	link.l1 = "Знаю, знаю. Так как насчет моей помощи?";
    ...
    case "JSTStep_7":
        ...
        dialog.text = "Что ж, я уже угнал у хозяина сего дивного местечка несколько пиастров...";
    	link.l1 = "Это как раз то, что мне нужно.";
    ...
    case "JSTStep_8":
    	...
    	link.l1 = "Ты угрожал мисс... тьфу, о чем это я? Вернее, о чём это ТЫ?";
    ...
    case "JSTStep_9":
        ...
        dialog.text = "Найди мне того, кто согласится доставить меня на Тортугу за три тысячи, и я дам тебе полторы. Ну что, идет?";
    	link.l1 = "Я могу попробовать.";
        link.l1.go = "JSTStep_10";
       	link.l2 = "Не интересно.";
    ...
    case "JSTStep_11":
    	...
    	link.l1 = "Корвет ''Плавучий британец'' капитана Джона Майнера уже ждет.";
    ...
    case "JSTStep_13":
        ...
        dialog.text = "Конечно, конечно! Я просто хотел выразить тебе глубочайшую признательность и предложить отведать этого крепчайшего рома...";
    	link.l1 = "Полторы тысячи, Жак!";
    ...
    case "MNStep_0":
    	...
    	link.l1 = "Добрый день, мое имя Питер Блад. Могу я просить вас об одолжении, капитан? Одному моему другу очень нужно добраться до Тортуги, и он готов распрощаться с тремя тысячами пиастров.";
        link.l1.go = "MNStep_1";
    ...
    case "MNStep_1":
    	...
    	link.l1 = "Конечно. Его зовут... Жан-Поль. М-да...";
        link.l1.go = "MNStep_2";
       	link.l2 = "Конечно. Его имя Жак Соловей, смекаешь?..";
        link.l2.go = "MNStep_3";
       	link.l3 = "Нет.";
        link.l3.go = "MNStep_4";
    ...
    case "MNStep_2":
        ...
        dialog.text = "Жан-Поль? Француз?";
    	link.l1 = "А почему нет? Тортуга - французский порт. Он собиратель, скупает старье.";
        link.l1.go = "MNStep_5";
    ...
    case "MNStep_4":
    	...
    	link.l1 = "Вполне можете. Скажем так, это некий мистер Смит, который даст вам три тысячи денег, если вы перестанете задавать вопросы.";
        link.l1.go = "MNStep_6";
    ...
    case "MNStep_6":
    	...
    	link.l1 = "Мистер Смит почтет за честь.";
        link.l1.go = "MNStep_Exit";
