...
//********************************* Диалоги кэпа, который увез де Барраса из Тортуги **********************************
		...
		break;
  		case "Step_H7_2":
			...
			link.l1 = "А-а-а, черт! Слушай, ты же пират, какого дьявола ты якшаешься с испанцами?!";
    	...
    	break;
		case "Step_H8_13":
			dialog.text = "Извольте получить карту. Послушайте, я рад, что сумел наконец продать эту бесполезную для меня вещь. Но будьте так добры, скажите мне, зачем она вам?";
        ...
        break;
		case "Step_H8_15":
			dialog.text = "Прекрасно, сударь. Вы сможете найти меня на Тортуге в таверне.";
