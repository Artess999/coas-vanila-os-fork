...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		break;
		case "ansewer_2_1":
			dialog.text = "Здесь нет сундуков без ключей, приятель. Все открывается только ключами. И учти, что кроме тебя еще куча народу, у кого такие ключи имеются. Если хочешь что-нибудь надежно спрятать, то нужно искать сундук где-нибудь за Городом, куда плыть нужно...";
			link.l1 = "Ага, понятно...";
			link.l1.go = "int_quests";
		break;
		case "ansewer_3":
		...
		break;
		case "ansewer_5_4":
			dialog.text = "Ну, не хочешь говорить - не надо. А на свой вопрос ты сам и ответил. Ищи старых жителей...";
			link.l1 = "Как понять?";
