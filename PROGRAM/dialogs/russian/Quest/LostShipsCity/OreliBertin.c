	...
	switch(Dialog.CurrentNode)
	{
		case "First time":
			...
			if (npchar.quest.meeting == "0")
			{
				...
				{
					if (npchar.location == "FurieShipInside2") dialog.text = "Боже мой, как шторм!.. Здравствуйте, меня зовут " + GetFullName(npchar) + ", я хозяйка этого дома.";
					else dialog.text = "Боже мой, как шторм!.. Здравствуйте, меня зовут " + GetFullName(npchar) + ".";
					link.l1 = "Очень приятно. А я - капитан " + GetFullName(pchar) + ". Вернее, бывший капитан. А все из-за этого дьявольского шторма!";
					link.l1.go = "FS_1";
				}
				else
				{
		...
		case "SessilDead":
			...
			link.l1 = "Нет, но я, как и Хилл Брюннер, искал человека, который смог бы мне ответить на вопрос. Она, наверное, смогла бы.";
		...
		case "SeekGoods_1":
			...
			link.l1 = "Нужен. Вы знаете, 100 центнеров этого хлама мне будет достаточно.";
			link.l1.go = "SeekGoods_2";
		break;
		case "SeekGoods_2":
			dialog.text = "Ну хорошо, можете забирать.";
			link.l1 = "Вот дьявол, я сам не дотащу! Вы не подскажете, кто может организовать доставку на барк 'Сан Габриэль'?";
