...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		break;
		case "SeekCrew_2":
			dialog.text = "Ты уверен?";
			link.l1 = "Да. Это сказал Механик.";
			link.l1.go = "SeekCrew_3";
		break;
		case "SeekCrew_3":
			dialog.text = "Вот черт, я верю Механику... Ну что же, в таком случае, я согласен.";
			link.l1 = "Ты принял правильное решение, поздравляю. А сейчас, немедленно отправляйся на 'Сан Габриэль'. Механик переправит тебя на мой корвет.";
