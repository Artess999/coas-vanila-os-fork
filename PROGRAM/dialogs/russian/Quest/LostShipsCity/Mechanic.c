...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		break;
		case "Man_FackYou":
			dialog.text = LinkRandPhrase("Да ты вор!!! Нарушение Закона Города!", "Вот это да! Чуть я загляделся, а ты сразу в сундук с головой! Он нарушил Закон!", "Милиция! Грабят!!! Держи его, он нарушил Закон!");
		...
		case "LSCNotBlade":
			dialog.text = LinkRandPhrase("Слушай, ты бы убрал оружие. А то нервируешь немного...", "Знаешь, у нас тут не принято сабелькой размахивать. Убери оружие.", "Слушай, что ты, как три мушкетера, бегаешь тут, шпагой машешь? Убери оружие, не к лицу это серьезному мужчине...");
		...
		case "CitizenNotBlade":
			...
			{
				dialog.text = NPCharSexPhrase(NPChar, "Осторожнее на поворотах, приятель, когда бежишь с оружием в руках. Я ведь могу и занервничать...", "Мне не нравится, когда мужчины ходят передо мной с оружием наизготовку. Это меня пугает...");
		...
		case "FT_1":
			dialog.text = "Хорошо, очень хорошо... Будьте добры, назовите себя, мой досточтимый друг.";
		...
		case "FT_3":
			...
			link.l1 = "Всех до единого. А до этого я пустил под нож еще и клан 'Нарвал'.";
			link.l1.go = "FT_4";
		break;
		case "FT_4":
			dialog.text = "Хе-хе, так Город теперь лишен разбойников? Н-да, снимаю шляпу, как говорится\nНу, а теперь расскажите мне, пожалуйста, что ради чего вы совершали эти впечатляющие подвиги.";
			link.l1 = "Как вам сказать... Понимаете, я по собственной инициативе попал на этот остров, расследую гибель Тизера Дэна. Ну а теперь хочу убраться отсюда.";
			link.l1.go = "FT_5";
		break;
		case "FT_5":
		...
		case "FT_9":
			...
			link.l1 = "Жаль, конечно. Вы знаете, столько хороших людей умерло за последнее время, что я уже устал жалеть...";
			link.l1.go = "FT_10";
		break;
		case "FT_10":
		...
		break;
		case "FT_11":
			dialog.text = "Видел собственными глазами... Ну ладно, это, опять же, потом. Сейчас расскажите мне, друг мой, что творится в Городе и зачем вы пришли ко мне.";
			link.l1 = "В городе хозяйничает адмирал Чад Каппер. Граждане города живут согласно положениям Закона, одно из которых запрещается строить любые плавательные средства. Ну, а я случайно узнал о Механике и решил побеседовать с вами любой ценой. Вот, собственно, и все...";
			link.l1.go = "FT_12";
		break;
		case "FT_12":
			dialog.text = "Чад Каппер твердо держит бразды правления Городом, как и раньше...";
			link.l1 = "Ну, я бы не сказал, что твердо. Два клана уничтожены один за другим, происходят убийства граждан. Люди недовольны адмиралом и его милицией, ведь это в их обязанность входит обеспечение безопасности!";
			link.l1.go = "FT_13";
		break;
		case "FT_13":
			dialog.text = "Вы знаете, друг мой, я совершенно не удивлюсь, если окажется, что за всем происходящим в Городе так или иначе стоит адмирал.";
		...
		break;
		case "FT_15":
			dialog.text = "Какие выборы, друг мой! Нужно спасать свои жизни, пока еще не поздно...";
			link.l1 = "О чем это вы?";
			link.l1.go = "FT_16";
		break;
		case "FT_16":
			dialog.text = "Вы знаете, почему меня зовут Механиком?";
			link.l1 = "Знаю. Вы придумали способ крепления кораблей Города между собой. Да и вообще, насколько я слышал, смастерить что-нибудь эдакое для вас не проблема.";
			link.l1.go = "FT_17";
		break;
		case "FT_17":
		...
		case "FT_25":
			...
			link.l1 = "Понятно. Так что я должен сделать?";
			link.l1.go = "FT_26";
		break;
		case "FT_26":
		...
		break;
		case "FT_27":
			dialog.text = "Ну, я же не знаю точно, когда случится катастрофа. К тому же, я вижу, что вы человек смелый и деятельный, и вам вполне по силам будет выполнить мои условия. Тем более, что я много не прошу, всего лишь полтора миллиона за корвет и возможность один раз спуститься под воду.";
			link.l1 = "Полтора миллиона?! Я не ослышался?";
			link.l1.go = "FT_28";
		break;
		case "FT_28":
		...
		break;
		case "FT_29":
			dialog.text = "Ну, деньги здесь не проблема, друг мой. Ищите, и, полагаю, без труда отыщете нужную мне сумму, так как Город буквально напичкан ценностями. К тому же, можно занять у Августо Брамса, он охотно дает в долг до миллиона монет.";
		...
		break;
		case "FT_30_1":
			dialog.text = "Но вы же справились с 'касперами', справитесь и этой проблемой... Ну, что же вы робеете?! Как будто это не вы только что положили целую орду головорезов...";
			link.l1 = "Хорошо, я согласен.";
			link.l1.go = "FT_31";
		break;
		case "FT_31":
			dialog.text = "Ну, вот и отлично! Жду вас с деньгами, друг мой, и это только первый вопрос. Сейчас вам нужно явиться к Чаду Капперу, рассказать ему, что я освободился, так сказать... Только никаких выборов! Иначе он убьет вас.";
			link.l1 = "Я понял, что выборы того не стоят.";
			link.l1.go = "FT_32";
		break;
		case "FT_32":
			dialog.text = "Они просто не состояться, вот и все... В общем, передавайте Чаду от меня привет, уведомите его об уничтожении 'касперов'. Не думаю, что это его обрадует, но сделать это нужно.";
			link.l1 = "Зачем?";
			link.l1.go = "FT_33";
		break;
		case "FT_33":
		...
		break;
		case "FT_34":
			dialog.text = "Иначе он прикончит вас, друг мой. Не стоит злить адмирала, а вы это сделали. Чад имел дела с 'касперами', и я слышал в разговорах, что он готовился уплыть с ними из Города.";
		...
		case "FT_35":
			...
			link.l1 = "Понятно... Ну что же, я все понял. Пошел заниматься делами.";
			link.l1.go = "exit";
		...
		case "CheckMillion":
			...
			{
				link.l1 = "Пока не насобирал практически ничего.";
				link.l1.go = "CheckMillion_noMoney";
			}
			else
			{
				link.l1 = "Кое-что имеется. Я готов вручить вам некоторую сумму.";
		...
		break;
		case "FreeCorvett_2":
			dialog.text = "Да, подвох действительно имеется. Я уронил шестеренку от механизма лебедки в воду. Это шестеренку нужно достать со дна.";
		...
		case "FreeCorvett_5":
			...
			link.l1 = "Понятно... Ну что же, я готов.";
		...
		case "FreeCorvett_6":
			...
			link.l1 = "Понятно, что я ограничен во времени пребывания под водой. Остальное непонятно.";
		...
		case "DeepAgain":
			...
			link.l1 = "Опять деньги нужны? Я же принес вас вам полтора миллиона!";
		...
		break;
		case "DeepAgain_3":
			dialog.text = "Я не понимаю, на что вы жалуетесь. Я даю вам возможность заработать гораздо больше. Ведь на дне очень много ценностей. Если вы туда на прогулку спускались, то извините меня... В общем, нужно быть более расторопным там, на дне.";
			link.l1 = "Ясно...";
			link.l1.go = "exit";
		...
		case "takeArmor2":
			...
			{
				link.l3 = "Все, я закончил с погружениям. Более подводное царство меня не интересует.";
		...
		case "endImmersion_2":
			...
			link.l1 = "Я понял, постараюсь все сделать.";
			link.l1.go = "exit";
		...
		//Набор команды
		case "TakeCrew":
			dialog.text = "Прекрасно, друг мой, все уже размещено в трюме вашего корвета. Теперь вам нужно набрать команду из жителей Города. Сами понимаете, вдвоем мы с корветом не управимся.";
			link.l1 = "Хех, а раньше нельзя было об этом сказать? Я оббегал весь Город в поисках товаров на корвет, заодно мог бы и команду набрать.";
		...
		break;
		case "TakeCrew_4":
			dialog.text = "Именно так, друг мой. Я могу сказать с очень большой долей вероятности, что сейчас город будет разрушен. Так что поторопитесь.";
			link.l1 = "Хорошо, я так и сделаю. Кстати, вы сумели освободить корвет?";
			link.l1.go = "TakeCrew_5";
		break;
		case "TakeCrew_5":
			dialog.text = "Еще нет, но опробовал лебедку, она в полной готовности. Договаривайтесь с людьми, пусть сюда прибывают сюда, а я буду переправлять их на корабль. Нам нужно хотя бы пятнадцать человек, чтобы отплыть. Как только вы соберете необходимое количество - сразу же бегите сюда. По вашему прибытию на 'Сан Габриэль', мы задействуем лебедку и освободим корвет.";
			link.l1 = "Хорошо, я вас понял. Начну договариваться.";
			link.l1.go = "exit";
		...
		case "inPrison":
			...
			link.l1 = "Точно! Пришел на выручку.";
		...
		break;
		case "inPrison_2":
			dialog.text = "Я заперт в этой камере, а ключ конвоиры унесли адмиралу. Это было его приказ начальнику тюрьмы. Мне не вырваться из этой клетки.";
			link.l1 = "Адмирала больше нет, я разделался с ним. Но никакого ключа не находил... Я вернусь и поищу!";
			link.l1.go = "inPrison_3";
		break;
		case "inPrison_3":
			dialog.text = "Поздно, друг мой. Буря набирается силу.";
			link.l1 = "Я успею!";
		...
		case "inPrison_7":
			...
			link.l1 = "Я понял, спасибо вам... Может быть, все-таки попытаться открыть это чертову клетку?";
