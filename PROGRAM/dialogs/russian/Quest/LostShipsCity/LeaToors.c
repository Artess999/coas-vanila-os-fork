	...
	switch(Dialog.CurrentNode)
	{
		case "First time":
			...
			if (npchar.quest.meeting == "0")
			{
				...
				{
					if (npchar.location == "PlutoStoreSmall") dialog.text = "Приветствую вас, минхер, у себя дома. Меня зовут " + GetFullName(npchar) + ".";
					else dialog.text = "Приветствую вас, минхер. Меня зовут " + GetFullName(npchar) + ".";
					link.l1 = "А я - капитан " + GetFullName(pchar) + ". Справедливости ради надо заметить, что бывший капитан...";
					link.l1.go = "FT_1";
				}
			}
			else
			{
				dialog.text = "Я могу вам чем-нибудь помочь, минхер?";
				...
				{
					link.l4 = "Леа, я слышал, что вы знаете что-то о неком Лейтоне Декстере...";
