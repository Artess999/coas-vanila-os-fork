	...
	switch(Dialog.CurrentNode)
	{
		case "First time":
			...
			if (npchar.quest.meeting == "0")
			{
				...
				{
					if (npchar.location == "SantaFlorentinaShipInside4") dialog.text = "Этот шторм был очень сильным, сеньор, вам очень повезло, что вы смогли выбраться к нам... Меня зовут " + GetFullName(npchar) + ", в этом доме я хозяйка.";
					else dialog.text = "Этот шторм был очень сильным, сеньор, вам очень повезло, что вы смогли выбраться к нам... Меня зовут " + GetFullName(npchar) + ".";					
			...
			{
				if (npchar.location == "SantaFlorentinaShipInside4") dialog.text = "Что вам нужно у меня в доме, сеньор?";
				else dialog.text = "Я вас слушаю, сеньор.";
		...
		case "SeekGoods_1":
			...
			link.l1 = "100 центнеров будет вполне достаточно.";
		...
		break;
		case "SeekGoods_4":
			dialog.text = "На себя намекаете? Не стоит, место занято...";
			link.l1 = "Ни в коей мере, просто так спросил. Я думаю, что если съесть столько винограда и выпить столько вина, то вряд ли вы играть научитесь.";
		...
		break;
		case "TakeBombs_1":
			dialog.text = "На 'Сан Габриэль'... Ну хорошо, красавчик. За ваше старание я это организую. Попрошу своего избранника, он все сделает.";
			link.l1 = "Великолепно! Огромное спасибо вам и избраннику. Ему очень повезло...";
			link.l1.go = "TakeBombs_2";
		break;
		case "TakeBombs_2":
			dialog.text = "Спасибо... Да вы льстец, как я погляжу!";
			link.l1 = "Временами... Ну, всего хорошего.";
			link.l1.go = "exit";
