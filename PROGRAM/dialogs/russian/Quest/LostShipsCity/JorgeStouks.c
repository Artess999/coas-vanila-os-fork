...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		break;
		case "ansewer_5":
			dialog.text = "Здесь есть все, что есть в обычном городе - церковь, таверна, магазин. Если человек, ссужающий деньги. Но я скажу я вам - наиглупейшее это занятие здесь.";
			link.l1 = "Почему?";
