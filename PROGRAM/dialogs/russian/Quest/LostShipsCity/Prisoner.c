...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		case "prisonerHead":
			...
			{
				dialog.text = "Здравствуйте. Я так понимаю, что это вы - последний прибывший гражданин?";
			...
			{
				dialog.text = "Здравствуйте. Что вам нужно в этом тюрьме?";
				link.l1 = "Да ничего особенного. Просто так заскочил.";
				link.l1.go = "Exit";
		...
		case "prisoner":
			if (npchar.quest.meeting == "0")
			{
				dialog.text = "Приветствую. Я рад, что ты выжил и теперь находишься среди нас. Я тюремщик, меня зовут " + GetFullName(npchar) + ".";
			...
			else
			{
				...
				{
					link.l2 = "Приятель, я принес тебе бутылочку вина от твоего друга Доминика Легро. Выпей, расслабься, а то сидишь тут безвылазно...";
		...
		break;
		case "SeekCrew_3":
			dialog.text = "Хех, каков провидец, просто оторопь берет! Я порекомендую вам умерить прыть.";
		...
		break;
		case "WineLogro_1":
			dialog.text = "А тебе и не чего понимать. Просто передай, что я ему уши на ходу обрежу.";
		...
		case "SecondLogro":
			...
			link.l1 = "Передал я ему твои слова. Он очень удивился и клянется, что совершенно не в курсе того, что происходит.";
		...
		case "LastLegroAdd":
			dialog.text = "Да, ты прав... Слушай, передай Доминику, что все нормально. Я не сержусь на него.";
		...
		case "ArmoIsDead_2":
			...
			link.l1 = "Он сам мне это сказал. Но спешить тебе некуда, я уже прикончил его.";
			link.l1.go = "ArmoIsDead_3";
		break;
		case "ArmoIsDead_3":
			dialog.text = "Жаль...";
			link.l1 = "Ну, я бы так не сказал.";
