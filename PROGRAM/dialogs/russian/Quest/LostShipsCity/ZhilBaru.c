...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "FS_1":
			...
			link.l1 = "Знаете, я сейчас не совсем адекватен, ведь потерял все и всех. Поэтому впечатления пока ужасные.";
			link.l1.go = "FS_2";
		break;
		case "FS_2":
		...
		case "ELTHusb_SF":
			...
			link.l1 = "Я узнал, что вы вместе ушли из таверны в тот день, когда Тейлора арестовали. Что произошло? Как он попал в резиденцию к адмиралу?";
