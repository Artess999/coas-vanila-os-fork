	...
	switch(Dialog.CurrentNode)
	{
		case "First time":
			...
			else
			{
				...
				{
					link.l5 = "Приятель, как дела, как жизнь?";
					link.l5.go = "Tizer_1";
				}
		...
		break;
		case "FT_1":
			dialog.text = "В свое время я был в подмастерье у хозяина верфи на Тортуге, а после служил плотником на борту фрегата 'Андромеда'. К сожалению, мы оказались не в том месте и не в то время.";
			link.l1 = "Что произошло?";
			link.l1.go = "FT_2";
		break;
		case "FT_2":
			dialog.text = "Очень много всего, месье, очень много. И все сразу, представьте себе! Сперва рабы подняли восстание, а в самый разгар подавления нас атаковали охотники за головами, потому что у нас на борту находился один... человек, который был им нужен.\n"+
				"Жаркая абордажная схватка, а потом еще и шторм начался, а точнее, будто нас вынесло в какую-то штормовую зону. Далее наш фрегат наткнулся на скалы или рифы, дал течь и пошел ко дну. Я схватился за пустой бочонок и сумел привязаться к нему. Это спасло мне жизнь. Сутки меня болтало по океану, а потом вынесло сюда.";			
			link.l1 = "Лихо...";
			link.l1.go = "FT_3";
		break;
		case "FT_3":
		...
		break;
		case "FT_5":
			dialog.text = "Нет, приятель, я пас. С нашим адмиралом можно оказаться на дне гораздо раньше, чем снимешься с якоря.";
		...
		break;
		case "Man_FackYou":
			dialog.text = LinkRandPhrase("Да ты вор!!! Нарушение Закона Города!", "Вот это да! Чуть я загляделся, а ты сразу в сундук с головой! Он нарушил Закон!", "Милиция! Грабят!!! Держи его, он нашил Закон!");
		...
		case "CitizenNotBlade":
			...
			{
				dialog.text = NPCharSexPhrase(NPChar, "Осторожнее на поворотах, приятель, когда бежишь с оружием в руках. Я ведь могу и занервничать...", "Мне не нравится, когда мужчины ходят передо мной с оружием на изготовку. Это меня пугает...");
		...
		break;
		case "ansewer_1":
			dialog.text = "Хм-м, объединиться? Ну, попробуй – попутного ветра в горбатую спину. Я... мы любим казни, нам нравится смотреть на тебе подобных, чьи силуэты медленно растворяются в морской пучине.";
		...
		break;
		case "Tizer_4":
			dialog.text = "М-да, что-то непонятно... Знаешь что, давай об этом деле поговорим в другом месте. Тебе известно, где находится корвет 'Протектор'? Иди туда и подожди меня в каюте. Ну, а я следом, чтобы нам не вместе тусоваться.";
