...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		case "First time":
			...
			dialog.text = "Приветствую моего друга и просто очень хорошего человека. Чем я могу тебе помочь?";
		...
		break;
		case "InPrison_2":
			dialog.text = "Элис Тейлор, друг. Она хозяйка флейта 'Церес Смити'. А меня зовут Максим Тейлор.";
		...
		case "InPrison_wait":
			dialog.text = "Эх, друг, на тебя вся моя надежда выйти отсюда. Пожалуйста, поскорее найди Элис...";
			link.l1 = "Ладно.";
			link.l1.go = "exit";
		break;
