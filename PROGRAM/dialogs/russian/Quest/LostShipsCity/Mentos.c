...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "SeekGoods_2":
			...
			link.l1 = "Согласен, тем более, что хорошая компания мне просто необходима.";
		...
		case "SeekGoods_3":
			...
			link.l1 = "Мне нужно 200 центнеров пороха и 50 центнеров оружия. Доставить это нужно на барк 'Сан Габриэль'.";
		...
		case "SeekCrew":
			...
			link.l1 = "Я сейчас как раз набираю команду на корабль, так что добро пожаловать. Отправляйся на 'Сан Габриэль'. Хенрик Ведекер, который там находиться, переправит тебя на мой корвет.";
		...
		break;
		case "SeekCrew_2":
			dialog.text = "Адмирал тобой очень недоволен. Полагаю, что он готовиться прикончить тебя. Поэтому я подожду здесь, посмотрю, что будет дальше. Если у тебя наступят проблемы с Чадом - я смогу прикрыть твою спину.";
		...
		case "SeekCrew4":
			...
			link.l1 = "Если ты поможешь мне сейчас, то я готов взять тебя офицером с достойным ежемесячным окладом. Мы уходим, и твоя помощь мне нужна прямо сейчас.";
