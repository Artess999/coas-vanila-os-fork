	...
	switch(Dialog.CurrentNode)
	{
		case "First time":
			...
			if (npchar.quest.meeting == "0")
			{
				...
				{
					dialog.text = "Здравствуйте, сэр. Я очень рада, вы сумели спастись после этой ужасной катастрофы... Хотя, что говорить, мы все через это прошли... Вы знаете, скоро этот шторм закончится, и настроение у вас точно поднимется. Да, меня зовут " + GetFullName(npchar) + ".";
					link.l1 = GetFullName(pchar) + " к вашим услугам, мисс... Скажите, после каждого шторма у вас бывает пополнение?";
					link.l1.go = "FS_1";
				}
				else
				{
					dialog.text = "Здравствуйте, сэр. Я очень рада, вы сумели спастись после этой ужасной катастрофы... Хотя, что говорить, мы все через это прошли. Да, меня зовут " + GetFullName(npchar) + ".";
			...
			else
			{
				...
				{
					link.l7 = "Я слышал, что вы ищете помощи в одном деле...";
		...
		case "SeekGoods_1":
			...
			link.l1 = "100 центнеров вполне хватит.";
		...
		case "ELTHusb_toElis_1":
			...
			link.l1 = "Послушайте, вы хотите вытащить его оттуда или нет? Если хотите, то я мог бы помочь в этом деле.";
		...
		case "ELTHusb_toElis_3":
			...
			link.l1 = "Это нужная штука, я согласен!";
			link.l1.go = "ELTHusb_begin_4";
			link.l2 = "Извините, мне это не нужно.";
			link.l2.go = "ELTHusb_begin_disagree";
		break;
		...
		case "ELTHusb_good":
			...
			link.l1 = "Ну, я кое-что выяснил и рассказал об этом адмиралу. Чад согласился дать вашему мужу еще один шанс остепениться.";
