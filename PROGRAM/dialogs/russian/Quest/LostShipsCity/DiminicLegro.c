...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		case "First time":
			...
			if (npchar.quest.meeting == "0")
			{
				...
				if (CheckAttribute(loadedLocation, "storm"))
				{
					...
					link.l1 = "Ну, здравствуй, " + pchar.name + ". Мое имя " + GetFullName(pchar) + ", будем знакомы. А что значит 'вовремя'?";
					link.l1.go = "FS_1";
				}
				else
				{
					dialog.text = "Мои поздравления новоприбывшему. Я " + GetFullName(npchar) + ", меня еще зовут здесь Счастливым.";
					link.l1 = "Ну, здравствуй, " + pchar.name + ". Мое имя " + GetFullName(pchar) + ", будем знакомы.";
					link.l1.go = "FT_1";
				}
			}
			else
			{
				...
				{
					dialog.text = "Эй, приятель, у меня к тебе есть дело.";
					link.l1 = "Выкладывай.";
				...
				{
					link.l7 = "Знаешь, передал я от тебя бутылку вина Томасу Бойлу.";
				...
				{
					link.l7 = "Ну что же, я все уладил с Томасом Бойлом.";
		...
		break;
		case "ansewer_3":
			dialog.text = "Конечно, приятель! Прямиком в преисподнюю!";
			link.l1 = "Благодарю.";
			link.l1.go = "int_quests";
		...
		//найм команды
		case "SeekCrew":
			dialog.text = "К-хе.. ошарашил, однако...";
		...
		case "GiveVineBottle_1":
			...
			link.l1 = "Приятель, ты, часом, не сбрендил? Я что, по-твоему, мальчик на побегушках?";
		...
		case "GiveVineBottle_2":
			dialog.text = "Ну, спасибо тебе, дружище. Томас-то как обрадуется!..";
			link.l1 = "Надеюсь.";
			link.l1.go = "exit";
		...
		case "FackDominic_3":
			...
			link.l2 = "Черта с два! Я тебе что, мальчик на побегушках?";
			link.l2.go = "GiveVineBottle_not";
		break;
		case "FackDominic_4":
			dialog.text = "Спасибо тебе, дружище! Я клянусь, что совершенно не догадываюсь, в чем тут дело.";
			link.l1 = "Я верю тебе.";
			link.l1.go = "exit";
		...
		break;
		case "ArmoDominic_2":
			dialog.text = "Дружище, окажи мне еще одну услугу.";
			link.l1 = "Опять?..";
		...
		break;
		case "ArmoDominic_5":
			dialog.text = "Спасибо тебе, приятель!";
		...
		break;
		case "KeyDominic_1":
			dialog.text = "Это Томас, узнаю друга\nДружище, я тебе бесконечно благодарен!";
