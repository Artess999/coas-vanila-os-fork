...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		case "First time":
			...
			{
				dialog.text = "Когда я не у себя в резиденции, то, в принципе, не прочь поговорить... Что ты хотел?";
				link.l1 = "Да так, просто хотел узнать, все ли в порядке в Городе.";
				link.l1.go = "NRes_1";
			}
			...
			{
				link.l4 = "Адмирал, я хотел поговорить об убийстве Хилла Брюннера.";
				link.l4.go = "BarmenDead_1";
			}
			if (pchar.questTemp.LSC == "fromMechanicToAdmiral")
			{
				link.l4 = "Адмирал, я хотел поговорить с тобой.";
			...
			{
				link.l5 = "Адмирал, я хотел бы помочь Максиму Тейлору.";
				link.l5.go = "ELTHusb_SF";
			}
			if (CheckAttribute(pchar, "questTemp.LSC.ElisHusband") && pchar.questTemp.LSC.ElisHusband == "toAdmiralGood")
			{
				link.l5 = "Адмирал, я тут узнал кое-что об обстоятельствах того дела с Тейлором.";
		...
		case "NRes_1":
			dialog.text = "Да, все хорошо. Я рад, что тебя так живо заботит наш Город. Ты хороший гражданин.";
			link.l1 = "Рад стараться, адмирал!";
			link.l1.go = "exit";
		break;
		...
		break;
		case "FT_7_2":
			dialog.text = "Третье: за воровство в Городе полагается смертная казнь. Если тебя застукают копающемся в чужом сундуке - ты автоматически лишаешься гражданства и становишься вне Закона. А это значит, что права на жизнь у тебя больше нет...";
		...
		break;
		case "FoundHero_1":
			dialog.text = "Хочешь сказать, что ты не знал о том, что ко мне нужно явиться сразу же, как только оказался в Городе?";
			link.l1 = "Не знал...";
		...
		break;
		case "NarvalRing_3":
			dialog.text = "Хо-хо, да это же амулет 'нарвала'! Так, где ты его нашел, говоришь?";
		...
		break;
		case "NarvalRing_10":
			dialog.text = "Никак, сдрейфил? Ты же пиратский кэп, что это с тобой?!";
			link.l1 = "Их много. А я хоть и был пиратским капитаном, но не самоубийца.";
		...
		case "Interception_1":
			...
			link.l1 = "Хе-хе... Ты знаешь, а ведь все случилось само собой. Я, так сказать, только показал на них пальцем этому идиоту...";
			link.l1.go = "Interception_2";
		break;
		case "Interception_2":
			sld = characterFromId("Blaze");
			dialog.text = "Какому идиоту?";
			link.l1 = "Да этому новому гражданину, " + GetFullName(sld) + " его зовут. Ты, наверное, слышал, что убили одного милиционера и нашего плотника. Так вот, этот новый гражданин принес мне амулет нарвалов и сказал, что нашел его на месте убийства. Хоть это и шито белыми нитками, я не стал долго разбираться с этим делом, так как подвернулся удобный случай осуществить давно задуманное, не навлекая на себя подозрения. Послал этого 'героя' на разборки, дал ему еще людей из милиции в подмогу.";
			link.l1.go = "Interception_4";
		break;
		case "Interception_4":
			dialog.text = "Ну, то, что он на тебя поработал – это прекрасно. Но ты, надеюсь, не ввел его в курс наших дел?";
			link.l1 = "Нет, я не доверяю ему. На Большой земле он был каперским капитаном, а таких людей всегда нужно опасаться. Одно дело использовать его в своих интересах, а другое – подключать к нашему делу.";
		...
		break;
		case "BarmenDead_3":
			dialog.text = "Иди, друг мой, и ищи, как следует. Только на этот раз я не буду так легковерен... Ты меня понял?";
			link.l1 = "Хм, не очень...";
			link.l1.go = "BarmenDead_4";
		break;
		case "BarmenDead_4":
			dialog.text = "Сейчас, прежде чем принимать решение наказать кого-то, я проведу собственное дознание.";
			link.l1 = "Ага, теперь понял. Дознание – это то, чего я добиваюсь. Поставишь меня в известность о ходе следствия?";
		...
		case "CasperDead_1":
			...
			link.l1 = "Ну, помнишь, ты говорил, чтобы я самостоятельно занялся убийством Хилла Брюннера?";
			link.l1.go = "CasperDead_2";
		break;
		case "CasperDead_2":
			dialog.text = "Я такое говорил? Ты что, сбрендил?!";
			link.l1 = "Ну, ты мне это не поручал, но и не запрещал. Так что я, с твоего разрешения, пошел искать улики. Ну, и зашел на 'Сан Габриэль'.";
			link.l1.go = "CasperDead_3";
		break;
		case "CasperDead_3":
			dialog.text = "Идиот! Я что, не говорил тебе не лезть туда?";
			link.l1 = "Нет, ты говорил, что у них на 'Сан Габриэле' свои законы. Я же не знал, что законы эти такие кровожадные! В общем, набросились они на меня, ну и мне пришлось защищаться...";
			link.l1.go = "CasperDead_4";
		break;
		case "CasperDead_4":
			dialog.text = "И что?";
			link.l1 = "Защитился. Клана 'Каспер' более не существует... Так же, впрочем, как и клана 'Нарвал'. Город теперь свободен он негодяев всех мастей!";
		...
		break;
		case "CasperDead_6":
			dialog.text = "Да ты дьявол какой-то! Два клана пустил под нож!";
			link.l1 = "Осмелюсь заметить, что один из них - по твоему прямому приказанию.";
			link.l1.go = "CasperDead_7";
		break;
		case "CasperDead_7":
			dialog.text = "Н-да... Кого-нибудь нашел на 'Сан Габриэле'? Кроме 'касперов', конечно.";
			link.l1 = "Да. Человек по имени Хенрик Ведекер передавал тебе привет.";
			link.l1.go = "CasperDead_8";
		break;
		case "CasperDead_8":
			dialog.text = "Значит, Механик жив...";
			link.l1 = "А чего с ним будет? Он же на меня не нападал, ну и я его не тронул...";
			link.l1.go = "CasperDead_9";
		break;
		case "CasperDead_9":
			dialog.text = "Хм, не тронул... Вот что, 'крутой Уокер'! Ты меня всерьез утомил своими выходками. Я сейчас очень зол на тебя и подумываю, не отправить ли тебя на дно с грузом на шее!";
			link.l1 = "Адмирал, я больше так не буду!..";
			link.l1.go = "CasperDead_10";
		break;
		case "CasperDead_10":
			dialog.text = "Заткнись, полудурок!\nТы еще жив только потому, что я хочу закончить эту череду убийств. Кто бы ни был в этом виноват, я не хочу вести дальнейших расследований. Допустим, что во всем виноваты 'касперы', и на этом поставим точку. Тебе ясно?";
			link.l1 = "Да, адмирал.";
			link.l1.go = "CasperDead_11";
		break;
		case "CasperDead_11":
			dialog.text = "Хорошо. Ты должен понимать, что теперь в Городе нет исключений. Кланов больше нет, соответственно теперь нет территорий, на которые не распространяется Закон Города. Тебе ясно?";
			link.l1 = "Да, адмирал.";
		...
		break;
		case "SeekGoods_2":
			dialog.text = "Твои шашни с Ведекером до добра не доведут! Ты обязан соблюдать положения Закона Города.";
		...
		break;
		case "SeekGoods_4":
			dialog.text = "С какой это стати? На мой вопрос, зачем тебе это, ты ответа не дал. А вдруг ты хочешь заложить куда-нибудь бочонок с порохом, а потом взорвать?";
			link.l1 = "Да ты что, адмирал, я же не сумасшедший.";
		...
		break;
		case "SeekGoods_6":
			dialog.text = "Знаешь, ты стал популярен среди граждан. Если бы не это обстоятельство, думаю, что скормил бы тебя тем тварям, что копошатся под городом.";
		...
		break;
		case "SeekCrew_5":
			dialog.text = "Я этого бреда от Механика вдоволь наслушался. Вот что, приятель, я тебе скажу. И советую хорошенько это запомнить, так как я предупреждаю тебя в последний раз.\nПока я здесь адмирал, я и буду решать, когда мы уйдем из Города. Понятно?";
			link.l1 = "Чад, я не претендую стать адмиралом. Не скрою, раньше хотел... Но теперь вопрос стоит о жизни и смерти.";
			link.l1.go = "SeekCrew_6";
		break;
		case "SeekCrew_6":
			dialog.text = "Раньше хотел? Хм, я так и знал, что ты не успокоишься...";
		...
		break;
		case "SeekCrew_7":
			dialog.text = "Хех, ты мне еще о моих планах расскажи!\nНу, что же, спасибо за познавательную беседу. А теперь можешь быть свободен. И не вздумай пугать граждан, а не то я тебе башку откручу! Учти, что терпеть тебя я больше не намерен.";
			link.l1 = "Ну что же, я сделал все, что мог. Жаль, что ты не слушаешь меня...";
			link.l1.go = "exit";
			AddQuestRecord("ISS_MainLine", "60");
		break;
		//финальный диалог
		case "fightTalking":
			dialog.text = "Твое время вышло. Ты готов к смерти?";
			link.l1 = "Гм.. ну, я как-то специально не готовился...";
		...
		break;
		case "fightTalking_2":
			dialog.text = "Ты неправильно их использовал.";
			link.l1 = "Эх, жаль...";
		...
		break;
		case "LostDecster_6":
			dialog.text = "Понятно. По поводу Декстера, ты, надеюсь, понял, что он занят. Поэтому его для знакомства можешь не искать.";
