...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		break;
		case "ansewer_1_1":
			dialog.text = "Интересным? А вы любитель риска, наверное – бывалый джентльмен удачи, да? Ну, попробуйте сходить в гости к 'нарвалам', например...";
			link.l1 = "Это вы про клан 'Нарвал'?";
			link.l1.go = "ansewer_1_2";
		break;
		case "ansewer_1_2":
			dialog.text = "О них, родимый. Впечатлений будет масса, обещаю.";
		...
		break;
		case "AfterFight_2":
			dialog.text = "Молодой человек, вот что я вам скажу... Я, наверное, старейший житель этого острова, и не такое еще видела здесь.";
		...
		break;
		case "AfterFight_5":
			dialog.text = "Хм, ну надо же... Вы знаете, с тех пор, как его изолировали, вы второй человек, которому я рассказаваю о нем. Первым был Тизер Дэн.";
		...
		case "AfterFight_9":
			...
			link.l1 = "Вы сказал, что его изолировали...";
		...
		case "AfterFight_11":
			...
			link.l1 = "Вы имеете ввиду это покушение на убийство?";
		...
		case "AfterFight_14":
			...
			link.l1 = "Понятно. Полагаю, что я должен добраться до вашего гениального Хенрика и переговорить с ним.";
