	...
	switch(Dialog.CurrentNode)
	{
		case "First time":
			...
			if (npchar.quest.meeting == "0")
			{
				...
				{
					dialog.text = "Здравствуйте! Я рада вас видеть. Вы знаете, в этом ужасном шторме выжили, похоже, только вы... Ой, простите, сэр, меня зовут " + GetFullName(npchar) + ".";
					link.l1 = GetFullName(pchar) + " к вашим услугам. Рад приветствовать гостеприимных хозяев.";
					link.l1.go = "FS_1";
				}
				else
				{
					dialog.text = "Здравствуйте! Я рада видеть нового гражданина. Вы знаете, в том ужасном последнем шторме выжили, похоже, только вы... Ой, простите, сэр, меня зовут " + GetFullName(npchar) + ".";
					link.l1 = GetFullName(pchar) + " к вашим услугам. Рад приветствовать гостеприимных хозяев.";
					link.l1.go = "FT_1";
				}
			}
			...
			{
				dialog.text = "Вам что-то нужно, сэр?";
		...
		case "FS_2":
			...
			link.l1 = "Я также рад знакомству с приятным в общении человеком. Я так понимаю, что Город немноголюден.";
			link.l1.go = "FT_2";
		break;
		...
		case "FT_2":
			...
			link.l1 = "Мой корабль разбился, и я потерял всю команду. К сожалению... Хотя, с другой стороны, мне еще и повезло.";
			link.l1.go = "FT_3";
		break;
		case "FT_3":
			...
			else
			{
				if (sld.sex == "man")
				{
					...
					else
					{
						...
						{
							dialog.text = LinkRandPhrase("Простите, но он находится прямо здесь, " + npchar.quest.seekIdx.where + ". Вам нужно быть внимательным.", "Хм, он ведь здесь, среди нас!", "Если бы вы посмотрели вокруг более внимательно, то наверняка уже увидели бы его...");
						}
						else
						{
