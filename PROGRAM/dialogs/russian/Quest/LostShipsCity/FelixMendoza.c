...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "SeekGoods":
			...
			link.l1 = HeroStringReactionRepeat("Элис Тейлор сказала мне, чтобы я обратился с этим к тебе...",
				"Отлично!",
                "А-а, ну да.",
		...
		case "SeekGoods_1":
			...
			link.l1 = "Из флейта 'Церес Смити' 100 центнеров ядер нужно доставить на барк 'Сан Габриэль'.";
		...
		case "SeekCrew_1":
			...
			link.l1 = "Прямо сейчас отправляйтесь на 'Сан Габриэль', там Механик организует переправу на корвет.";
