	...
	switch(Dialog.CurrentNode)
	{
		case "First time":
			...
			else
			{
				...
				{
					link.l8 = "Послушай, мне нужно кое-что перетащить на барк 'Сан Габриэль'. Хотел попросить тебя помочь мне.";
		...
		break;
		case "FT_3":
			dialog.text = "И это правильно, приятель. Нельзя давать печали овладеть твоим разумом, иначе тут долго не протянешь! У некоторых крыша и едет, такой ладно если только себя погубит, а то ведь и Городу навредит. Сам понимаешь, мы тут и так непонятно на чем держимся, а как начинают корабли ходить - так вообще жутко. Скрип, треск, палубы под ногами пляшут...";
		...
		break;
		case "ansewer_1":
			dialog.text = "Это Город Потерянный Кораблей, приятель. Имей в виду, что Город - живой. Некоторые граждане в это не верят, но ты знай, что так оно и есть!";
		...
		case "SeekGoods_1":
			...
			link.l1 = "Из пинаса 'Фурия' 100 центнеров книппелей нужно доставить на барк 'Сан Габриэль'.";
