...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		break;
		case "PortSpein_3":
			dialog.text = "Очень хорошо. Но я должен быть уверен, что эта вещь попадет именно тому, кто сумеет верно ею распорядиться - я обещал это одному человеку. Поэтому я предлагаю вам ответить на один вопрос, чтобы я мог понять, действительно ли вы тот, кто мне нужен. Согласны?";
		...
		break;
		case "Villemstad_7":
			dialog.text = "Не желаете - как хотите. Прощайте, бравый капитан...";
			link.l1 = "До свидания.";
			link.l1.go = "exit";
		...
		break;
		case "PortPax_7":
			dialog.text = "Не желаете? Ну, прощайте. И как такой бездарь капитаном работает?..";
		...
		case "SanJuan_check":
			...
			{
				dialog.text = "Нет, капитан, ответ неверный. Предлагаю все-таки дать правильный ответ.";
				link.l1 = "Повторим...";
		...
		break;
		case "PortRoyal_1":
			dialog.text = "Я хочу предложить вам обмен. Дело в том, что у меня имеется вещица, которая мне совершенно ни к чему, ну, а вам пригодится уж точно.";
		...
		break;
		case "PortRoyal_7":
			dialog.text = "Не желаете - как знаете. Хм, а на вид такой солидный капитан...";
		...
		case "Santiago_3":
			...
			link.l1 = "Хм, хоть я и не понимаю, зачем вам это, тем не менее, я согласен.";
		...
		case "Santiago_check":
			...
			{
				dialog.text = "Хм, капитан, этот ответ меня устроить не может. Он неправильный! Прошу вас, попробуйте еще раз...";
		...
		case "Santiago_ok":
			...
			link.l1 = "Да уж, с этим не поспоришь. Ну что же, придется прогуляться. Спасибо вам и всего хорошего.";
			link.l1.go = "exit_over";
			NextDiag.TempNode = "good_all";
