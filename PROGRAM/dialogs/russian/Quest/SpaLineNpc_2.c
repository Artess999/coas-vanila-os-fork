...
//*************************** Квест №2, диалоги с Франциско на выходе из Инквизиии ***************************
		...
		break;
 		case "Step_S2_15":
			dialog.text = "Не хочу показаться назойливым, но, видя, как вы держались и разделались с этими людьми, я понял, что вы человек военный. Хочу попросить вас об одном одолжении.\n"+
		...
		break;
 		case "Step_S2_16":
			dialog.text = "Она пропала у нас где-то 20 лет назад вместе с ее хранителем - Самуэлем Кохэно.";
			link.l1 = "Где-то я уже слышал это имя...";
			link.l1.go = "Step_S2_17";
		break;
 		case "Step_S2_17":
			dialog.text = "Это вряд ли. Так вот, недавно мы вышли на след похитителя, он объявился на Бермудах. Попытки выкупить у него реликвию не принесли результата, тогда мы наняли матросов из таверны. Вор оказался на удивление силен и даже ранил нескольких человек, после чего бросился бежать. Матросы следовали за ним по пятам и нагнали у верфи. Но там он как сквозь землю провалился.";
			link.l1 = "Как это?";
			link.l1.go = "Step_S2_18";
		break;
 		case "Step_S2_18":
			dialog.text = "Он зашел в контору верфи - и все. Куда он делся - совершенно непонятно. Хозяин верфи нам так ничего и не сказал. Я прошу вас помочь мне вернуть книгу. Вы поможете мне?";
