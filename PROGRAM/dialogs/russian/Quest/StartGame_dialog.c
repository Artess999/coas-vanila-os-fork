...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Node_2":
			...
			XI_ConvertString("people"+GetNationNameByType(sti(pchar.HeroParam.EnemyNation)) + "Acc") + ", ты не растерялся и взял управление в свои руки. И приказал драпать. Так что команда, точнее, то, что от нее осталось, единогласно и выбрала тебя кэпом.";
		...
		case "Node_3":
			dialog.text = "Вот-вот, матросы так и сказали - 'Есть, сэр!' и полезли на ванты выполнять маневр. Удачно мы тебя подобрали в порту "+
			              XI_ConvertString("Colony" + pchar.HeroParam.FromCityId + "Gen") + ", куда ты прибыл из Европы. Если бы не ты - мы без капитана давно кормили бы акул. А тебя ранило взрывом бомбы, когда нам вдогонку дали бортовым залпом.";
		...
		case "Node_5":
			dialog.text = "Ну вот. Все в порядке - сам убедился. Но последствия ранения и длительное отсутствие практики могут сказаться на твоих умениях. А нам нужен капитан, который сделает нас богачами! Хочешь потренироваться в фехтовании, руку размять?";
		...
		case "Advice_9":
			dialog.text = "Еще можно поднять на корабле враждебный флаг, если он у тебя есть, и уповать на свою удачу и скрытность. Ну, а самый надежный способ благополучно проникнуть во вражеский город - купить лицензию национальной торговой компании, в этом случае тебя никто не задержит. Однако, не забудь флаг на корабле поднять соответствующий. Сам понимаешь, глупо пытаться предъявить испанскую лицензию, если флаг у тебя на мачте - английский.";
			link.l1     = "Дальше.";
		...
		/////   фехт
		case "Teach_1":
			dialog.text = "Ну что же, начнем, пожалуй. Не знаю, как там у вас в Европе фехтуют, а у нас тут главное - выжить. Для этого нужно иметь хороший клинок и уметь с ним обращаться. Есть три атакующих удара: обычный удар, выпад и пробивной удар. Защитных действий тоже три: блок, парирование и финт. Есть еще защитно-атакующий круговой удар. И, конечно же, пистолет, чтобы противника издалека свинцовой пилюлей угостить.";
