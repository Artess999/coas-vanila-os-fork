...
//>>>>>>>>>>>>========= Разброс диалогов по персонажам =====================
            ...
            {
    			dialog.text = "Я благодарен вам за удачно завершившееся путешествие. И благодарен вдвойне за то, что вы так вовремя появились в Сан-Мартине. Я надеюсь, мы встретимся еще.";
...
//********************************* Дилоги лейтенанта в тюрьме. Квест №3 **********************************
		...
		break;
 		case "Step_H3_2":
			...
			link.l1 = "Я обещаю, что выпущу тебя на свободу. Но сначала я должен получить необходимую мне информацию. Я хочу знать, куда Мэдтфорд готовит высадку десанта.";
			link.l1.go = "Step_H3_3";
		break;
 		case "Step_H3_3":
			dialog.text = "Будет взят и уничтожен голландский форт Оранж.";
			link.l1 = "Черт возьми, все указывало именно на это! Я держу свое слово: ты свободен и можешь идти куда угодно. Прощай.";
...
//********************************* Поиски Библии. Квест №8 **********************************
		...
		break;
        case "Step_H8_11":
			dialog.text = "Я уверен в этом практически на сто процентов. Приступайте, друг мой. В случае успеха награда будет очень высокой.";
