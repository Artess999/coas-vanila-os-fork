	...
	switch(Dialog.CurrentNode)
	{
		...
		break;
 		...
 		case "Step_10":
        	dialog.text = "Хорошо. Слушай теперь, что мне нужно разыскать.\n"+
                          "Мне нужна статуэтка Ачкуацина, посла ацтеков, объявляющего войну, церемониальный сосуд и церемониальных нож.";
		...
		break;
 		...
 		case "Step_20":
        	...
        	link.l1 = "Да, испанцы нашли близ бухты Аматике, что южней Белиза, индейский храм и сейчаст там работает целая экcпедиция. А к этому месту со всего Нового света стягиваются груженные корабли.";
    		link.l1.go = "Step_21";
		break;
