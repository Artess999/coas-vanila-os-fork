...
//>>>>>>>>>>>>========= Разброс диалогов по персонажам =====================
            ...
            {
    			dialog.text = "Ну что же, вот мы и дождались нашего гостя. Добро пожаловать на ужин, месье. Главное блюдо для вас сегодня - добрая толедская сталь!";
		...
		break;
 		case "Step_F1_4":
			dialog.text = "Эти деньги ваши, извольте получить.\n"+
				          "Прощайте и будьте здоровы, месье.";
...
//********************************* Месть Анне де Лейва. Квест №5 **********************************
		...
		break;
 		case "Step_F5_2":
			...
			link.l1 = "Не было бы дела, не спрашивал бы, поверьте уж...";
		...
		break;
 		case "Step_F5_4":
			...
			link.l1 = "Я тот, кто отправил уважаемого дона Хосе на тот свет. Еще и слуг его туда же, вслед за хозяином.";
...
//********************************* Франсуа Олоне. Квест №6 **********************************
		...
		break;
 		case "Step_F6_4":
            ...
            {
				dialog.text = "Коллега, но я могу взять в это дело тебя одного, на условиях, что твоя доля - четвертая часть. Больше мне компаньоны не требуются. Поэтому избавься от лишних кораблей, если хочешь участвовать. И побыстрей!";
		...
		break;
 		case "Step_F6_14":
			if (sti(pchar.money) >= 200000)
			{
				...
				link.l2 = "А я вот думаю, что не обязан с тобой делиться. Всю работу сделал я!";
