...
// ============================================================================
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Step_45":
        	dialog.text = "И душой своей бессмертной. А чего ты хотел? Шашни с силами зла смертного приводят точно в Aд.";
		...
		case "ClimeUsurer":
			dialog.text = "Хе-хе... Что, приятель, вляпался?";
			link.l1 = "Аззи, черт возьми, как я рад тебя видеть!!!";
			link.l1.go = "ClimeUsurer_1";
		break;
		case "ClimeUsurer_1":
			dialog.text = "Не чертыхайся, не люблю я этого\nЧто делать-то думаешь?";
			link.l1 = "Думал, что все, конец мне. Теперь, вот, уже так не думаю. Аззи, как я рад тебя видеть, дружище!..";
			link.l1.go = "ClimeUsurer_2";
		break;
		case "ClimeUsurer_2":
			dialog.text = "Да и я, признаться, тоже. Ты меня забавляешь, смертный. Все что-то тебе надо, все куда-то не в свое дело лезешь\nСейчас умудрился с индейскими демонами связаться. Угораздило же...";
			link.l1 = "Аззи, я и подумать не мог, что дойдет до такого! Кстати, а где это я, ты не в курсе?";
		...
		break;
		case "ClimeUsurer_4":
			dialog.text = "Даже не знаю... Он тебя ведь по делу закрыл. На кой ляд ты деньги брал у его прихвостня?";
			link.l1 = "Аззи, если бы я знал, то ни за какие коврижки на это не пошел! Клянусь тебе...";
		...
		case "ClimeUsurer_5":
			...
			link.l1 = "Понял, не дурак.";
			link.l1.go = "ClimeUsurer_6";
		break;
		case "ClimeUsurer_6":
			dialog.text = "Ладно, прощай, смертный.";
