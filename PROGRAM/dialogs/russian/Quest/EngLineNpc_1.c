...
//>>>>>>>>>>>>========= Разброс диалогов по персонажам =====================
            ...
            if (pchar.questTemp.State == "MorrisWillams_ModifordGood5000" && npchar.id == "Morris_Willams")
            {
                ...
                dialog.text = "Черт возьми! Я послушался тебя, зашел в порт и у меня тут же конфисковали груз! Ты подставил меня!";
            ...
            {
                dialog.text = "Ты захватил мой индиго?";
                link.l1 = "У берегов Сан-Хуана я захватил тот самый испанский пинас. Только в трюмах не оказалось ни индиго, ни серебра, ни красного дерева.";
                link.l1.go = "Step_E6_10";
            }
            if (pchar.questTemp.State == "MorrisWillams_PinnaceBoardNotFoundMoney" && npchar.id == "Morris_Willams")
            {
                dialog.text = "Ты захватил мой индиго?";
                link.l1 = "У берегов Сан-Хуна я захватил тот самый испанский пинас. Только в трюмах не оказалось ни индиго, ни серебра, ни красного дерева. Я обыскал весь корабль, но ничего ценного не нашел, извини.";
                link.l1.go = "Step_E6_11";
            }
            if (pchar.questTemp.State == "MorrisWillams_DieHard" && npchar.id == "Morris_Willams")
            {
                dialog.text = "Ты захватил мой индиго?";
                link.l1 = "Извини, но этот пинас оказался мне не по зубам. Я не сумел взять его.";
                link.l1.go = "Step_E6_11";
            }
...
//<<<<<<<<<<<<===== Разброс диалогов по персонажам =====================
        ...
        case "in_the_SentJons":
            ...
            {
                dialog.text = "Я благодарен вам от всей души. Вы проявили настоящий героизм в сражении с серьезным противником. К тому же, в Сент-Джонс мы успели в срок. Я даю вам письмо для сэра Томаса Мэдифорда, передайте эту депешу ему лично в руки. Прощайте!";
...
//********************************* Диалоги тюремщика по четвертому квесту английки **********************************
		...
		break;
 		...
 		case "Step_E4_2":
			...
			link.l1 = "Купить драгоценности и кое-какое испанское барахло. Я корсар, не хотел идти на Тортугу, решил сдать добычу поблизости.";
...
//**************************************** Диалоги Морриса Уильямса **************************************
        ...
        case "Step_E6_10":
            ...
            link.l2 = "Полагаю, испанцы продали его по дороге. В каюте капитана я нашел сто сорок тысяч монет! Это твои деньги, теперь ты можешь рассчитаться с долгами.";
        ...
        if (sti(pchar.money) >= 140000)
        {
            dialog.text = "Ты сдержал слово, спасибо! Отныне ты мой друг навсегда. Мне нечем тебя сейчас отблагодарить. Правда... есть одна вещица, важность которой в нашем деле трудно переоценить. Ты человек бесстрашный и, возможно, сможешь сделать то, на что я и моя команда решиться так и не смогли.";
        ...
        case "Step_E6_14":
            dialog.text = "Вещица - это кираса, второй такой на Карибах, полагаю, нет. Об стальном слушай дальше... \n"+
                          ...
                          "Вот у него то, кроме другой прекрасной амуниции, и была та самая кираса, настоящее произведение искусства и в крайней степени надежный доспех. Хотел я было вернуться к кораблю потом, но мои оставшиеся в живых головорезы в слезах уговорили меня не делать этого.\n"+
        ...
        case "Step_E6_20":
			dialog.text = "Так и есть. Мне удалось перехватить небольшую эскадру, состоящую из трех испанцев.\n"+
                          "Мой фрегат атаковал этих ханжей-католиков, и те бросились наутек, вместо того, чтобы сообща противостоять мне. Я взял галеоны на абордаж по очереди!";
...
//**************************************** Диалоги Томаса Линча **************************************
        ...
        case "Step_E12_3":
            dialog.text = "Он больше не является губернатором Ямайки. Вы должны знать, что терпение правительства лопнуло.\n"+
                          "По назначении губернатором Ямайки Мэдифорд имел совершенно четкие распоряжения от Его Величества Карла II обуздать пиратство и поддерживать дружеские отношения с Испанией.\n"+
        ...
        case "Step_E12_6":
            dialog.text = "Более того, мы имеем совершенно четкие основания полагать, что Мэдифорд сохраняет существующее в Порт Рояле положение вещей ради собственных корыстных интересов.\n"+
        ...
        case "Step_E12_14":
            dialog.text = "Э-э-эх, черт возьми... Договорились! Половина от конфиската - ваша. Итак, я назначаю вас своим помощником и даю вам поручение чрезвычайной важности.\n"+
