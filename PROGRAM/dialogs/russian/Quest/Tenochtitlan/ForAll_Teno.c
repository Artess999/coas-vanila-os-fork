...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Shore53":
			dialog.text = "Сеньор, уходите отсюда! Уплывайте немедленно!";
			link.l1 = "В чем дело?";
		...
		break;
		case "Shore53_9":
			dialog.text = "Сеньор, не ходите туда. Это место проклято!";
			link.l1 = "Я все-таки рискну.";
			link.l1.go = "Shore53_10";
		break;
		case "Shore53_10":
			dialog.text = "Ну, дело ваше, а с меня хватит. Прощайте, сеньор!";
			link.l1 = "Прощай...";
			link.l1.go = "exit";
