...
//>>>>>>>>>>>>========= Разброс диалогов по персонажам =====================
            ...
            {
    			dialog.text = "Месье, нам нужно на всех парусах идти к Кумане. Не приведи Гоcподь, опоздаем - и там не будет реалов! Вы не знаете нашего капитана...";
...
//********************************* Похищение донны Анны. Квест №3 **********************************
 		case "Step_F3_1":
			...
			link.l1 = "Я знаю, сеньора, догадался... Я прошу вас следовать за мной. Будьте внимательны, сударыня...";
...
//********************************* Проблемы донны Анны. Квест №5 **********************************
 		case "Step_F5_1":
			dialog.text = "Да, это так. Сеньор, донне де Лейва грозит смертельная опасность! Генерал-губернатор Гаваны Франсиско Орегон-и-Гаскон предпринял расследование по этому поводу и выяснил все обстоятельства бегства донны Анны на Тортугу.\n"+
...
//********************************* Вызволение Рока Бразильца. Квест №7 **********************************
		...
		break;
 		case "Step_F7_5":
			dialog.text = "Послушай, я хочу тебя отблагодарить за спасение моей жизни. Деньгами помочь не могу - я должен внести изрядную сумму уплатить в казну Франции.\n"+
