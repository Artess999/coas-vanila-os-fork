	...
	switch(Dialog.CurrentNode)
	{
		...
		case "First time":
			if (sti(NPChar.nation) == PIRATE)
			{
				...
				link.l2 = "Н-да... На тебе не заработать, только если сдать тебя как преступника в каком-нибудь порту за выкуп. А может, взять тебя к себе офицером?";
			...
			link.l3 = "Мне не нужны пленники - мне нужны хорошие рабы!";
			link.l3.go = "Slave_1";
        ...
        case "free_to_officer":
			...
			{
    			dialog.text = "Офицером, " + GetAddress_Form(NPChar) + "? Пожалуй, я согласен, другого выхода у меня просто нет!";
