...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    ...
    switch (Dialog.CurrentNode)
	{
        ...
        break;
        case "Step_1_7":
            dialog.text = "Ну что же, вами сделан первый успешный шаг на тернистом пути карьеры для ее Величества Королевы-матери Марии-Анны Австрийской. Получите честно заработанные 50 тысяч. Рад, что не ошибся в вас.";
