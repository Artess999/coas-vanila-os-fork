...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "node_3":
			...
			{
				link.l1 = "Падре, таверну штурмует толпа подвыпивших горожан. Уверяют, что там засел оборотень, но я говорил с ним и видел всего лишь перепуганного человека. Он хочет исповедоваться!";
		...
		case "MC_CaracasChirch":
			dialog.text = "Сын мой, Церковь спасает заблудших. Оборотней, ведьм и колдунов наставляет на путь истинный Святая Инквизиция. Или простые горожане, если Господь изберет их своим орудием. Кто мы такие, чтобы вмешиваться?";
			link.l1 = "Но если он и правда не виновен? Странно: мне, корсару, приходится взывать к совести священника!";
			link.l1.go = "MC_CaracasChirch_1";
		break;
		case "MC_CaracasChirch_1":
			dialog.text = "Не горячитесь, сын мой. Если его душа невинна, то она попадет в рай! Но если я исповедую исчадие ада\nВпрочем, есть способ проверить. Дьявольское отродье не сможет войти в храм Божий. Если вы приведете его сюда и не поразит его кара небесная - конечно, я не откажу ему в исповеди.";
