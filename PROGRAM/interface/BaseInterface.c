...
{
	questTextFileName[0] = "resource\ini\texts\" + LanguageGetLanguage() + "\questbook\quest_book_an1.txt";
	questTextFileName[1] = "resource\ini\texts\" + LanguageGetLanguage() + "\questbook\quest_book_an2.txt";
